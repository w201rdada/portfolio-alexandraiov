...
library(magrittr)
readLines('https://www.zotero.org/api/users/4665018/items/top?limit=25&format=bibtex&key=6iZz0NfINNcehRoHoN7J99gq&v=1') %>% writeLines('portfolio-alexandraiov/references.bib')
```
